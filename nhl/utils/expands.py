...
class ScheduleExpands(str, Enum):
    ...
    schedule_game_content_editorial_articles = 'schedule.game.content.editorial.articles'
    ...
    schedule_game_content_highlights_scoreboard = 'schedule.game.content.highlights.scoreboard'
    schedule_game_content_highlights_gamecenter = 'schedule.game.content.highlights.gamecenter'
    schedule_game_content_highlights_milestone = 'schedule.game.content.highlights.milestone'
